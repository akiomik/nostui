...
use crate::{collections::EventSet, state::AppState, widgets::TextNote};
...
impl ElmHomeData {
    ...
    pub fn get_display_name(state: &AppState, pubkey: &PublicKey) -> String {
        state
            ...
            .unwrap_or_else(|| crate::widgets::PublicKey::new(*pubkey).shortened())
    }
}
...
mod tests {
    ...
    fn create_test_state_with_notes(note_count: usize) -> AppState {
        ...
        let profile = crate::nostr::Profile::new(keys.public_key(), Timestamp::now(), metadata);
    ...
    fn test_get_timeline_authors() {
        ...
        let sortable1 = crate::nostr::SortableEvent::new(event1);
        let sortable2 = crate::nostr::SortableEvent::new(event2);
        let sortable3 = crate::nostr::SortableEvent::new(event3);
